...
HOST = '10.101.50.102'  # Address of the client on ETCnet
...
mapping = [(3,32,30,36), (3,26,28,38), (3,42,1,23), (3,6,25,10), (3,41,31,29),
           ...
           (3,3,21,34), (3,14,47,13), (3,15,2,4), (3,5,12,11), (3,35,37,27),
           (1,37,38,33), (1,25,24,46), (1,15,16,17), (1,12,4,45), (1,20,19,18),
           (3,22,44,45), (3,40,19,20), (3,18,16,17), (3,9,7,8), (3,33,43,39),
           (1,27,35,26), (1,41,31,39), (1,43,44,23), (1,6,10,5), (1,9,11,7),
           ...
           (0,24,41,45), (0,29,43,22), (0,37,35,39), (0,21,11,6), (0,5,14,16)]
...
def update():
    while True:
        if G_chunk != None:
            ...
            chunk1 = G_chunk.copy()
            try:
                el_range_list = list(range(0, len(chunk1), 4))
                shuffle(el_range_list)
                for i in el_range_list:
                    time.sleep(0.001)
                    cube = chunk1[i]
                    newR = chunk1[i+1]
                    newG = chunk1[i+2]
